...
for(gcm in gcms)
{
  data.in<-paste("D:/RStudio/Climate Change/Climate Change/BCSDm Runoff W 2070/",gcm,"_rcp85_totalrunoff_stn_W_2070-2099_HD.csv",sep="")
...
for(gcm in gcms)
{
  data.in<-paste("D:/RStudio/Climate Change/Climate Change/BCSDm Runoff E 2070/",gcm,"_rcp85_totalrunoff_stn_E_2070-2099_HD.csv",sep="")
...
for(gcm1 in gcms1)
{
  data.in<-paste("D:/RStudio/Climate Change/Climate Change/LOCA Runoff W 2070/",gcm1,"_rcp85_totalrunoff_stn_W_2070-2099_HD.csv",sep="")
...
for(gcm1 in gcms1)
{
  data.in<-paste("D:/RStudio/Climate Change/Climate Change/LOCA Runoff E 2070/",gcm1,"_rcp85_totalrunoff_stn_E_2070-2099_HD.csv",sep="")
